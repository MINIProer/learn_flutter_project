...
class _JRHomePageState extends State<JRHomePage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: JRAnimatedIcon(this.sizeAnimation),
      ),
...
class JRAnimatedIcon extends AnimatedWidget {
  Animation _sizeAnimation;
  JRAnimatedIcon(this._sizeAnimation) : super(listenable: _sizeAnimation);

  @override
  Widget build(BuildContext context) {
    print('icon 的 builder');
    return Icon(
      Icons.people,
